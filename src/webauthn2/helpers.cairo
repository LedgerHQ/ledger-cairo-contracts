...
use traits::Into;
use clone::Clone;
use ledgerCairoContract::webauthn2::types::PublicKeyCredentialDescriptor;
use ledgerCairoContract::webauthn2::types::PublicKeyCredential;
use ledgerCairoContract::webauthn2::types::CollectedClientData;
use ledgerCairoContract::webauthn2::types::DomString;
