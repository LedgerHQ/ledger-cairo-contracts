use ledgerCairoContract::access::ownable::dual_ownable::DualCaseOwnable;
use ledgerCairoContract::access::ownable::dual_ownable::DualCaseOwnableTrait;
use ledgerCairoContract::access::ownable::interface::IOwnableCamelOnlyDispatcher;
use ledgerCairoContract::access::ownable::interface::IOwnableCamelOnlyDispatcherTrait;
use ledgerCairoContract::access::ownable::interface::IOwnableDispatcher;
use ledgerCairoContract::access::ownable::interface::IOwnableDispatcherTrait;
use ledgerCairoContract::tests::mocks::dual_ownable_mocks::CamelOwnableMock;
use ledgerCairoContract::tests::mocks::dual_ownable_mocks::CamelOwnablePanicMock;
use ledgerCairoContract::tests::mocks::dual_ownable_mocks::SnakeOwnableMock;
use ledgerCairoContract::tests::mocks::dual_ownable_mocks::SnakeOwnablePanicMock;
